...
- GP-2912：当 JVM 参数已经设置代理时，不再添加默认参数
- GP-2856：启动器初始化网络背景图片时，若 8000ms 内未收到响应则放弃加载，避免因网络问题无法进入主界面
- GP-2912：当下载失败时，打印重定向链至日志

错误修复

- GP-2919：修复了极低版本上，资源路径保存错误导致游戏启动后没有声音的问题
- GP-2920：修复了在 CurseForge 下载源中使用中文搜索会导致无法呈现结果的问题
- GP-2926：修复 saveETagIndex 可能写入不全导致网络缓存出错的问题
