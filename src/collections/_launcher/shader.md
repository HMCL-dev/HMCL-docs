...
![OptiFine_Install]({{ '/assets/img/docs/shader/optifine_install.png' | relative_url }})

点开之后会看到有 3 个复选框，一般而言，`正式版` 会比 `测试版` 更加稳定。选择安装 `正式版` ，如果没有 `正式版` 那么再考虑 `测试版` 。

![OptiFine_Selection]({{ '/assets/img/docs/shader/select_optifine.png' | relative_url }})
...
![OptiFine_AutoInstaller]({{ '/assets/img/docs/shader/install_auto-16338577874692.png' | relative_url }})
...
![Path_Selection]({{ '/assets/img/docs/shader/change_path.png' | relative_url }})
...
![OptiFine_Compatibility]({{ '/assets/img/docs/shader/optifine_compatibility.png' | relative_url }})
...
![Oculus]({{ '/assets/img/docs/shader/oculus.png' | relative_url }})
...
![Iris]({{ '/assets/img/docs/shader/iris.png' | relative_url }})
...
![Game_Dir]({{ '/assets/img/docs/shader/game_dir.png' | relative_url }})

如果你不知道版本隔离是啥，也不会创建文件夹，那么请打开游戏，依次点击 `设置—视频设置—光影—光影包文件夹` ，在里面放入光影包，然后点击你要加载的光影，最后点击 `完成` 即可

![Shader_Settings]({{ '/assets/img/docs/shader/shaders_setting.png' | relative_url }})
