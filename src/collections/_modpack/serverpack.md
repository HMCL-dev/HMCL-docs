...
![]({{ '/assets/img/docs/serverpack/1.png' | relative_url }})

选择导出为`服务器自动更新整合包`：

![]({{ '/assets/img/docs/serverpack/1-1.png' | relative_url }})

填写整合包信息，整合包下载链接前缀如何填写请看下文

![]({{ '/assets/img/docs/serverpack/1-2.png' | relative_url }})
...
![]({{ '/assets/img/docs/serverpack/1-3.png' | relative_url }})
...
![]({{ '/assets/img/docs/serverpack/1-4.png' | relative_url }})
...
![]({{ '/assets/img/docs/serverpack/1-6.png' | relative_url }})
