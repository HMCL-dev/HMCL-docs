...
![]({{ '/assets/img/docs/modpack-in-java/2-1.png' | relative_url }})

其中，`.minecraft` 是 Minecraft 文件夹，`jre-x64` 是你的 Java 运行时，我们分别来看看这两个文件夹的内容：

![]({{ '/assets/img/docs/modpack-in-java/2-2.png' | relative_url }})
...
![]({{ '/assets/img/docs/modpack-in-java/2-3.png' | relative_url }})
...
![]({{ '/assets/img/docs/modpack-in-java/2-4.png' | relative_url }})

在 `tutorial` 文件夹内右击空白区域打开快捷菜单，创建快捷方式。

![]({{ '/assets/img/docs/modpack-in-java/2-5.png' | relative_url }})
...
![]({{ '/assets/img/docs/modpack-in-java/2-6.png' | relative_url }})
...
![]({{ '/assets/img/docs/modpack-in-java/2-7.png' | relative_url }})
