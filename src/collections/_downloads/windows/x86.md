...
![windows-x86-1]({{ '/assets/img/docs/java-download-pages/windows-x86-1.gif' | relative_url }})

![windows-x86-2]({{ '/assets/img/docs/java-download-pages/windows-x86-2.gif' | relative_url }})

![windows-x86-3]({{ '/assets/img/docs/java-download-pages/windows-x86-3.gif' | relative_url }})
